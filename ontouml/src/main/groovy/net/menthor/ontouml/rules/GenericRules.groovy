...
class GenericRules {
    ...
    static boolean exactOne(Type self, String stereotypeCheckMethod, String listElemsMethod){
    ...
    static boolean excludesAsAncestor(Type self, String stereotypeCheckMethod, String ancestorCheckMethod, String ancestorCheckMethod2){
        if(self."${stereotypeCheckMethod}"()) {
    ...
    static boolean excludesAsAncestor(Type self, String stereotypeCheckMethod, String ancestorCheckMethod){
        if(self."${stereotypeCheckMethod}"()) {
            def value = self.allParents().every { p ->
    ...
    static boolean excludesAsParent(Type self, String stereotypeCheckMethod, String ancestorCheckMethod, String ancestorCheckMethod2){
        if(self."${stereotypeCheckMethod}"()) {
    ...
    static boolean excludesAsParent(Type self, String stereotypeCheckMethod, String ancestorCheckMethod){
        if(self."${stereotypeCheckMethod}"()) {
            def value = self.parents().every { p ->
                self.class.isInstance(p) && !p."${ancestorCheckMethod}"()
            }
    ...
    static boolean includesAsAncestorsOnly(Type self, String stereotypeCheckMethod){
        if(self."${stereotypeCheckMethod}"()) {
            def value = self.allParents().every { p ->
    ...
    static boolean typeMustBeConnectedToRelationship(Type self, String typeStereoCheckMethod, String relStereoCheckMethod){
    ...
    static boolean typeComposedByAtLeastTwoElements(Type self, String typeStereoCheckMethod, String listElemMethod, Integer number){
        if(self."${typeStereoCheckMethod}"()) {
